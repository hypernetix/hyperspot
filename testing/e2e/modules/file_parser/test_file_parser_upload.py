"""E2E tests for /file-parser/upload endpoint."""
import httpx
import pytest
...
async def test_upload_with_markdown_comparison(base_url, auth_headers, input_file, golden_md, test_id):
    """
    Test POST /file-parser/upload endpoint with markdown rendering.
...
async def test_upload_without_render_markdown(base_url, auth_headers):
    """
    Test POST /file-parser/upload endpoint without markdown rendering.
