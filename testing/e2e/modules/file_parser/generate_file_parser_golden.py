"""
Generate golden Markdown reference files for file_parser E2E tests.

This script:
1. Scans e2e/testdata/ for test input files (PDFs, DOCX, etc.)
2. Uploads each file to the /file-parser/upload endpoint with render_markdown=true
...
def generate_golden_markdown(input_file, base_url, headers, md_output_dir):
    ...
    try:
        ...
        # Call API endpoint
        url = f"{base_url}/file-parser/upload"
        params = {
...
def main():
    ...
    # testdata is at e2e/testdata, script is at e2e/modules/file_parser
