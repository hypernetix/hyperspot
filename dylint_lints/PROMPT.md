...
The lints should follow the norms established in the `https://github.com/hypernetix/DNA` repository, which is a separate repository from this one you should clone to a temporary location, and specifically adhere to the `RUST.md` norms that are contained within the repository.
