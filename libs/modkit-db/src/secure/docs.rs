...
//!
//! ```rust
//! use modkit_db::secure::{AccessScope, ScopeConstraint, ScopeFilter, FilterOp, pep_properties};
//! use uuid::Uuid;
//!
...
//!     ScopeFilter::new(pep_properties::RESOURCE_ID, FilterOp::In, vec![resource_id]),
//! ]));
//!
