...
ALWAYS open and follow `artifacts.json` WHEN registering Spaider artifacts, updating codebase paths, changing traceability settings, or running Spaider validation
