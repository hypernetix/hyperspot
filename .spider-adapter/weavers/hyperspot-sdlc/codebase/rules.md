...
- [CODE Rules](#code-rules)
  ...
  - [Tasks](#tasks)
    ...
    - [Phase 3: Spider Markers (Traceability Mode ON only)](#phase-3-spider-markers-traceability-mode-on-only)
...
- `../rules.md` — common Hyperspot SDLC rules shared by all kinds
