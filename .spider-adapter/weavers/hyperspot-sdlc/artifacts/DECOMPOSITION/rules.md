...
ALWAYS open and follow `{spider_adapter_path}/specs/patterns.md` WHEN mapping design elements to features and boundaries

ALWAYS open and follow `{spider_adapter_path}/specs/project-structure.md` WHEN choosing locations for FEATURE artifacts

## Hyperspot SDLC Chain (this weaver)
