...
ALWAYS open and follow `{spider_adapter_path}/specs/api-contracts.md` WHEN specifying endpoints, OpenAPI, OData, or error formats

ALWAYS open and follow `{spider_adapter_path}/specs/security.md` and `{spider_adapter_path}/specs/data-governance.md` WHEN specifying persistence and access control

ALWAYS open and follow `{spider_adapter_path}/specs/testing.md` WHEN writing acceptance criteria and test strategy

ALWAYS open and follow `{spider_adapter_path}/specs/performance.md` and `{spider_adapter_path}/specs/reliability.md` WHEN specifying latency/retry/timeout behavior
...
- [ ] Review against `docs/checklists/FEATURE.md` and `{spider_path}/weavers/sdlc/artifacts/SPEC/checklist.md`.
