...
- [ ] `p1` - **ID**: `cpt-cf-credstore-req-put-secret`
...
- [ ] `p1` - **ID**: `cpt-cf-credstore-req-get-secret`
...
- [ ] `p1` - **ID**: `cpt-cf-credstore-req-delete-secret`
...
- [ ] `p1` - **ID**: `cpt-cf-credstore-req-tenant-scoping`
...
- [ ] `p1` - **ID**: `cpt-cf-credstore-req-secretref-validation`
...
- [ ] `p1` - **ID**: `cpt-cf-credstore-req-sharing-modes`
...
- [ ] `p1` - **ID**: `cpt-cf-credstore-req-hierarchical-resolve`
...
- [ ] `p1` - **ID**: `cpt-cf-credstore-req-secret-shadowing`
...
- [ ] `p1` - **ID**: `cpt-cf-credstore-req-service-retrieve`
...
- [ ] `p1` - **ID**: `cpt-cf-credstore-req-authz-read`
...
- [ ] `p1` - **ID**: `cpt-cf-credstore-req-authz-write`
...
- [ ] `p1` - **ID**: `cpt-cf-credstore-req-authz-gateway`
...
- [ ] `p2` - **ID**: `cpt-cf-credstore-req-os-storage`
...
- [ ] `p2` - **ID**: `cpt-cf-credstore-req-rw-separation`
...
- [ ] `p1` - **ID**: `cpt-cf-credstore-req-nfr-confidentiality`
