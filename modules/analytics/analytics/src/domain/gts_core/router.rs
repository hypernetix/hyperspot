...
mod tests {
    ...
    fn test_router_routes_to_correct_feature() {
        ...
        let handler = router
            .route("gts.hypernetix.hyperspot.ax.schema.v1~acme.analytics._.instance_456.v1")
            .unwrap();
    ...
    fn test_router_returns_none_for_unknown_type() {
        ...
        let feature = router
            .route("gts.hypernetix.hyperspot.ax.unknown_type.v1~acme.analytics._.instance.v1")
            .unwrap();
