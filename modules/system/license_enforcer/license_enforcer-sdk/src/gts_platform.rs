...
///
/// ```text
/// gts.x.core.modkit.plugin.v1~x.core.license_enforcer.integration.plugin.v1~<vendor>.<package>.integration.plugin.v1
/// ```
///
/// # Example
///
...
///     "hyperspot.static_licenses.integration.plugin.v1"
/// );
///
