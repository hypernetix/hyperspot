...
| **Gateway** | Plugin discovery via GTS, request routing, self-access enforcement |
...
The gateway enforces self-access (source == target) before delegating to plugins, ensuring consistent behavior.
